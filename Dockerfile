...
# setup dependencies
ADD . /go/src/github.com/wajox/krakend-proxy
WORKDIR /go/src/github.com/wajox/krakend-proxy
...
COPY --from=builder /go/src/github.com/wajox/krakend-proxy/build/app .
